...
// =============================================================================
// CGAME.h - Lớp chính của CGAME, quản lý vòng lặp CGAME và mọi thứ
// =============================================================================
...
public:
    ...
    // Vòng lặp CGAME chính
    void run();

    // === Truy cập instance (Singleton-like) ===
    // Các State dùng CGAME::instance() để push/pop state, truy cập setting...
